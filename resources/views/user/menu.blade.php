<aside id="layout-menu" class="layout-menu menu-vertical menu bg-white text-dark border-end">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item">
            <a href="{{ route('user.index') }}" class="menu-link text-dark hover-bg-primary hover-text-white">
                <i class="menu-icon tf-icons bx bx-home-circle"></i>
                <div data-i18n="Analytics">Dashboard</div>
            </a>
        </li>
        <li class="menu-item mt-4">
            <a href="{{ route('logout') }}" class="menu-link text-dark hover-bg-primary hover-text-white" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
